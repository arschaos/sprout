package com.arschaos.web;

import com.arschaos.model.ArchitectureGraph;
import com.arschaos.model.ComponentNode;
import com.arschaos.model.ComponentType;
...
class SproutWebServerTest {
    ...
    void shouldStartAndServeEndpoints() throws Exception {
        ...
        assertThat(cssRes.headers().firstValue("Content-Type"))
                .hasValueSatisfying(ct -> assertThat(ct).contains("text/css"));
        ...
        assertThat(jsRes.headers().firstValue("Content-Type"))
